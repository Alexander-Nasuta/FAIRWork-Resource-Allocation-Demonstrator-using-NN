# flake8: noqa
description = "Fuzzy Logic DSS Demo for the FLEX Test Building Use Case."
dev = "Zi Xuang 'Melody' Tung, Sylwia Olbrych, Alexander Nasuta"
e_mail = "sylwia.olbrych@ima.rwth-aachen.de, alexander.nasuta@ima.rwth-aachen.de"
